...
**Frontend Features:**
- 🤖 Chat with AI agents (streaming responses)
- 📄 Upload and query documents (PDF/images)
- 📊 Real-time metrics and source citations
...
├── DOCUMENT_RAG_API.md     # Document RAG API guide (NEW)
├── SECURITY_GUARDRAILS.md  # Security and prompt injection prevention (NEW)
